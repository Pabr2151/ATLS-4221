...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 668.0, 462.0, 101.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 986.0, 138.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "storage of synth presets (json file). write and read edits the json. store 1,2,3 stores different the presets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1129.0, 106.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 383.0, 36.0, 581.0, 117.0 ],
					"presentation" : 1,
